...
export default function page() {
  ...
  return (
    <>
      <div className="AboutUs bg-orange-100" id="somos">
        <div className="item">
          <h2
            ...
            <div className="row">
              ...
              <div className="team-item">
                ...
                <p className="description">
                  Apasionada especialista en bienestar con más de 10 años de
                  experiencia en la industria del spa y la salud holística. Su
                  enfoque integral y su habilidad para conectar con las personas
                  la convierten en una profesional excepcional en el arte del
                  masaje terapéutico y los tratamientos relajantes.
                </p>
              </div>
              <div className="team-item">
